...
class LogInSignInPage extends StatefulWidget {
  ...
  @override
  State<LogInSignInPage> createState() =>
      _LogInSignInPageState();
}
...
class _LogInSignInPageState extends State<LogInSignInPage> {
          ...
          child: Form(
            child: Column(
                ...
                children: [
                  ...
                  _loginPicture,
                  userInfoUserName(
                      focusNodeTextField1st:
                          focusNodeTextField1st),
                  userInfoPassword(
                      focusNodeTextField4th:
                          focusNodeTextField4th),
                  _logInButton(),
                  _forgotMyPasswordButton()
                ]),
          ),
        ),
      ),
  ...
  Widget get _loginPicture => SizedBox(
        height: 180,
        width: 400,
        child: Padding(
        ...
        onPressed: () {
          Navigator.push(
              ...
              PageTransition(
                  ...
                  child: ForgotMyPassPagePage()));
        },
        child: Text('Parolamı Unutttum'));
  }
}
